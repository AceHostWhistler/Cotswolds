...
const ForestViewCascadeRoom = () => {
  ...
  const primaryImage = "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01907.jpg";
  const fallbackImage = "/photos/listings/Forest View Cascade/1 (1).jpg";

  const photos = [
    primaryImage,
    "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01781.jpg",
    "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01804.jpg",
    "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01812.jpg",
    "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01821.jpg",
    "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01829.jpg",
    "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01853.jpg",
    "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01866.jpg",
    "/photos/listings/Forest View Cascade/20240621 A7M3 01 A1_01879.jpg",
    // Cascade Exterior Photos
    fallbackImage,
    "/photos/listings/Forest View Cascade/9-2.jpg",
    "/photos/listings/Forest View Cascade/DSC_3404-2.jpg",
    "/photos/listings/Forest View Cascade/DSC_3410-2.jpg",
    "/photos/listings/Forest View Cascade/DSC_3410-22.jpg",
    "/photos/listings/Forest View Cascade/DSC_3419-2.jpg",
  ...
  return (
    <>
      <Head>
        <title>Forest View Cascade Rooms | Ace Cascade Lodge Hotel</title>
        <meta
          name="description"
          content="Immerse yourself in nature with our charming one-bedroom, one-bathroom hotel units in the center of Whistler Village, offering captivating views of the scenic Whistler forest."
        />
        ...
        <main className="pt-20">
              ...
              <div className="bg-gray-100 rounded-lg px-6 py-4 max-w-2xl w-full">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-800 text-center">
                    Queen bed | Kitchenette | Forest views
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4">
              {photos.slice(0, 6).map((photo, index) => (
                ...
                >
                  <Image
                    src={photo}
                    alt={`Forest View Cascade Room ${index + 1}`}
                    fill
                    ...
                    onError={(e) => {
                      console.error("Failed to load image, falling back to alternative");
          ...
          <div className="max-w-6xl mx-auto px-4 mb-16" id="details">
            <p className="text-gray-800 text-lg mb-8 max-w-4xl">
              Immerse yourself in nature with our charming one-bedroom, one-bathroom hotel units in the center of Whistler Village, offering captivating views of the scenic Whistler forest.
            </p>
              ...
              <div className="md:flex">
                <div className="md:w-2/3 p-6 sm:p-8">
                  ...
                  <div className="prose max-w-none text-gray-700">
                    <p className="mb-4">
                      Relax in the plush queen bed adorned with soft linens and high quality pillows, offering a cozy haven after a day of exploring the great outdoors. Our thoughtfully equipped kitchenettes feature modern amenities including a two-burner cooktop, dishwasher, microwave, kettle, toaster, Nespresso and drip coffee machine, and mini fridge, ensuring your comfort amidst the beauty of the natural surroundings.
                    </p>
                    <p className="mb-4">
                      Freshen up in the well-appointed bathrooms stocked with quality toiletries, each providing a shower and bathtub for your relaxation. As evening falls, unwind with a glass of wine and savor the enchanting views of the forest as it comes alive with the wonders of nature.
                    </p>
                  </div>
                </div>
                <div className="md:w-1/3 relative min-h-[300px]">
                  <Image
                    src="/photos/listings/Forest View Cascade/Patio View (5).jpg"
                    ...
                    onError={(e) => {
                      console.error("Failed to load image, falling back to alternative");
                      e.currentTarget.src = "/photos/listings/Forest View Cascade/IMG_8523.jpg";
                    }}
                  />
                </div>
              </div>
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="md:flex items-center gap-8 mb-6">
                  <div className="md:w-1/3 relative h-[250px] rounded-lg overflow-hidden shadow-md mb-4 md:mb-0">
                    <Image
                      src="/photos/listings/Forest View Cascade/IMG_8523.jpg"
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-12">
              <div className="md:flex flex-row-reverse">
                ...
                <div className="md:w-1/2 relative min-h-[350px]">
                  <Image
                    src="/photos/listings/Forest View Cascade/DSC_3404-2.jpg"
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-12">
              <div className="md:flex">
                ...
                <div className="md:w-1/3 relative min-h-[350px]">
                  <Image
                    src="/photos/listings/Forest View Cascade/1 (1).jpg"
            ...
            <div className="bg-gray-100 rounded-lg p-6 sm:p-8 mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Link href="/listings/mountain-view-rooms" className="group">
                  <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform duration-300 group-hover:shadow-lg">
                    <div className="relative h-48 w-full">
                      <Image
                    ...
                    <div className="p-4">
                      <h3 className="text-lg font-semibold text-gray-900 group-hover:text-[#0066CC] transition-colors">Mountain View Rooms</h3>
                    </div>
                  </div>
                </Link>
              </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center">
            ...
            <div className="relative h-[80vh] w-[80vw]">
              <Image
                ...
                alt={`Forest View Cascade Room ${selectedPhotoIndex + 1}`}
                fill
        ...
        {showAllPhotos && (
          <div className="fixed inset-0 bg-white z-50 overflow-y-auto">
            <div className="sticky top-0 bg-white shadow-md z-10 px-4 py-4 flex justify-between items-center">
              <h2 className="text-xl font-bold">Forest View Cascade Rooms Photos</h2>
              <button
...
export default ForestViewCascadeRoom; 