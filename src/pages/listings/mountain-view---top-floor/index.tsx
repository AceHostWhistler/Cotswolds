...
const MountainViewTopFloor = () => {
  ...
  const photos = [
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02388.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02364.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02373.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02380.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02411.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02427.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02435.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02459.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02500.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02519.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02529.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02552.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02562.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02569.jpg",
    "/photos/listings/Mountain View Top Floor/20240621 A7M3 05 A1_02579.jpg",
  ...
  return (
    <>
      <Head>
        <title>Mountain View - Top Floor | Ace Cascade Lodge Hotel</title>
        <meta
          name="description"
          content="Experience the charm of our newly renovated one-bedroom, one-bathroom apartment boasting breathtaking views of Whistler's Mountains and Forests."
        />
        ...
        <main className="pt-20">
          ...
          <div className="max-w-7xl mx-auto px-4 pt-8">
              ...
              <div className="bg-gray-100 rounded-lg px-6 py-4 max-w-2xl w-full">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-800 text-center">
                    Queen bed + sofa bed | Full kitchen | Mountain views | In-unit washer & dryer
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-8 sm:mb-10">
              ...
              <Link
                href="https://www.airbnb.ca/rooms/1151559188640677466?guests=1&adults=1&s=67&unique_share_id=bf99ed2d-0a0a-4187-a441-b56108381dbc"
                className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-[#0066CC] hover:bg-[#004C99] text-white rounded font-medium text-sm sm:text-base"
                target="_blank"
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4">
              {photos.slice(0, 6).map((photo, index) => (
                ...
                >
                  <Image
                    src={photo}
                    alt={`Mountain View Top Floor ${index + 1}`}
                    fill
          ...
          <div className="max-w-6xl mx-auto px-4 mb-16" id="details">
            <p className="text-gray-800 text-lg mb-8 max-w-4xl">
              Experience the charm of our newly renovated one-bedroom, one-bathroom apartment boasting breathtaking views of Whistler's Mountains and Forests.
            </p>
              ...
              <div className="md:flex">
                <div className="md:w-2/3 p-6 sm:p-8">
                  ...
                  <div className="prose max-w-none text-gray-700">
                    <p className="mb-4">
                      Sink into the plush queen bed with quality linens and soft pillows after a day of exploring Whistler's outdoor activities. Our full kitchen features a full fridge, oven, dishwasher, microwave, kettle, toaster, and drip coffee machine.
                    </p>
                    <p className="mb-4">
                      The living area features a gas fireplace and a sofa bed, increasing the sleeping capacity to four people. This beautiful apartment also features an in-unit washer & dryer.
                    </p>
                  </div>
                </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center">
            ...
            <div className="relative h-[80vh] w-[80vw]">
              <Image
                ...
                alt={`Mountain View Top Floor ${selectedPhotoIndex + 1}`}
                fill
        ...
        {showAllPhotos && (
          <div className="fixed inset-0 bg-white z-50 overflow-y-auto">
            <div className="sticky top-0 bg-white shadow-md z-10 px-4 py-4 flex justify-between items-center">
              <h2 className="text-xl font-bold">Mountain View Top Floor Photos</h2>
              <button
...
export default MountainViewTopFloor; 