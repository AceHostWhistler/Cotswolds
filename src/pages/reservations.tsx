          ...
          <div className="absolute inset-0 bg-black bg-opacity-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
              <div className="text-white max-w-2xl">
                <h1 className="text-4xl md:text-5xl font-light page-heading mb-4">Reservations</h1>
                <p className="text-xl">
        ...
        <div className="py-16 bg-gray-100 border-t border-gray-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light page-heading mb-4">Book your rental</h2>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden max-w-4xl mx-auto">
              <div className="bg-brand-gold text-black p-4 text-center">
                <h3 className="font-light page-heading text-xl uppercase tracking-wider">CALENDAR</h3>
