          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 p-6 md:p-8 flex flex-col justify-between">
                    <div>
                      ...
                      <h2 className="text-2xl font-bold mb-4 text-gray-900 hover:text-brand-gold transition-colors">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="text-brand-gold font-medium hover:text-amber-700 transition-colors"
                      >
                        Read More →
                      </Link>
                    </div>
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="p-5">
                  <h2 className="text-xl font-bold mb-2 text-gray-900 hover:text-brand-gold transition-colors">
                    <Link href="/blog-articles/activities-in-whistler">
            ...
            <div className="bg-gray-50 p-8 rounded-lg mt-16">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="flex justify-center space-x-6">
                  <a href="https://www.instagram.com/reelroom.yvr/" className="text-brand-gold hover:text-amber-700">
