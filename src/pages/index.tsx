    ...
    <div className={`min-h-screen ${!isPageLoaded ? 'opacity-0' : 'opacity-100 transition-opacity duration-300'}`}>
      ...
      <div className="relative min-h-screen bg-black">
        ...
        <div className="absolute top-8 left-8 z-20 flex space-x-4">
          <a href="https://www.tiktok.com/@reelroom.yvr" target="_blank" rel="noopener noreferrer" className="text-brand-gold hover:text-brand-cream transition-colors flex items-center justify-center w-12 h-12">
            <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z" />
            </svg>
          </a>
          <a href="https://www.instagram.com/reelroom.yvr/" target="_blank" rel="noopener noreferrer" className="text-brand-gold hover:text-brand-cream transition-colors flex items-center justify-center w-12 h-12">
            <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-96 rounded-lg overflow-hidden">
                <img 
                  src="/photos/homepage-originals/DSC03060.jpg" 
                  alt="Reel Room Space" 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm h-[380px] flex flex-col">
                <div className="h-48 overflow-hidden rounded-lg mb-6">
                  <img 
                    src="/photos/homepage-originals/DSC03275.jpg" 
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm h-[380px] flex flex-col">
                <div className="h-48 overflow-hidden rounded-lg mb-6">
                  <img 
                    src="/photos/homepage-originals/DSC03659.jpg" 
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm h-[380px] flex flex-col">
                <div className="h-48 overflow-hidden rounded-lg mb-6">
                  <img 
                    src="/photos/homepage-originals/DSC03469.jpg" 
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm h-[380px] flex flex-col">
                <div className="h-48 overflow-hidden rounded-lg mb-6">
                  <img 
                    src="/photos/homepage-originals/DSC03436.jpg" 
                    alt="Bar Services" 
                    className="w-full h-full object-cover object-center"
                    loading="lazy"
                    decoding="async"
